...
public:
	...
	template <typename T> static bool IsNumberBetween(T Number, T From, short To)
	{
	...
	static char ReadChoiceYesNo(string Message , string ErrorMessage = "Invalid Choice (y \ n), Enter again\n") {
		char answer;
		cout << Message << " ? y/n ? ";
