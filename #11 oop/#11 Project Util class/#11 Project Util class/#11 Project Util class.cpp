...
int main()
{
    ...
    cout << clsUtil::GenerateWord(clsUtil::MixCapitalSmallLetter, 8) << endl;
    cout << clsUtil::GenerateKey(clsUtil::MixCapitalSmallLetter) << endl;
    clsUtil::GenerateKeys(clsUtil::MixCharacterWithoutSpecialCharacter , 10);
    ...
    string Arr4[5];
    clsUtil::FillArrayWithRandomWords(Arr4, 5, clsUtil::MixCharacterWithoutSpecialCharacter, 8);
    cout << "\nArray after fill:\n";
    for (int i = 0; i < 5; i++)
    {
        cout << Arr4[i] << endl;
    ...
    string Arr5[5];
    clsUtil::FillArrayWithRandomKeys(Arr5, 5, clsUtil::MixCharacterWithoutSpecialCharacter);
