// #4,18 age in days.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
   ...
   cout << "\nYour Age is : " << differenceInTwoDays(birthDate , currentDate) << " Day(s).";
